...
api_key = "d5b88519eaa9d514032f99ff3c96118d02b0970973676c3bc221fc8f4011d5c0"  # Replace with your actual API key
directory_to_upload = "/Users/dstoica/Documents/Demos/WF/Files"  # Replace with the path to the directory containing files to upload
output_csv_file = "wildfire_analysis_results.csv"  # Replace with the desired name for the output CSV file
